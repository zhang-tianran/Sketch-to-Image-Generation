...
parser.add_argument("--lam1", type=float, default=0.15, help="coefficient of perceptual loss")
parser.add_argument("--lam2", type=float, default=0.85, help="coefficient of contextual loss")
